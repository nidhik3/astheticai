            ...
            <div class="txt3">
                ...
                <div class="row d-flex justify-content-center align-items-center">
                    <div class="col-md-4 d-flex justify-content-evenly align-items-center ">
                        <div class="col-md-5"> <a class="black" href=" ">Explore Features</a></div>
                        <div class="col-md-5"> <a class="transparent" href=" ">Get Started</a></div>
    ...
    <div class="container">
        ...
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-md-8 text-center">
                <p class="t1" style="line-height: 1;">Designed to fit into <span class="gradient"> your world</span> ,
...
<div class="bgimg pt-4" style="background-image: url('assets/img/banner1.png') ;width:100%; background-size: cover;">
    <div class="container">
        <div class="row d-flex justify-content-evenly">
            ...
            <div class="col-md-7">
                <div class="card card2 ">
                    <div class="card-body cbody pb-4">
                    ...
                    <img class="card-img-top ci " src="assets/img/card2.png" alt="Card image cap">
...
<section class="space">
    <div class="container">
        ...
        <div class="center-gradient py-3" style="background-image: url('assets/img/center-gradient.png');width:100%; background-size: cover;">
            ...
            <div class="txt1">
                ...
                <div class="row ">
                    <div class="col-md-6 text-start">
                        <p class="t1 gradient">Your practice, your rules,
...
<section class="space">
    <div class="container">
        ...
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-md-7 text-center">
                <p class="t1">Our Pricing Plans</p>
            </div>
        </div>
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-md-8 text-center">
